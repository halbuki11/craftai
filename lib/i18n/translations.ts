...
const translations = {
  ...
  // Workspace
  "ws.title": { en: "Team", tr: "Takım" },
  "ws.desc": { en: "Manage your workspace and team members", tr: "Çalışma alanınızı ve takım üyelerinizi yönetin" },
  "ws.create": { en: "Create Workspace", tr: "Çalışma Alanı Oluştur" },
  "ws.name": { en: "Workspace Name", tr: "Çalışma Alanı Adı" },
  "ws.members": { en: "Members", tr: "Üyeler" },
  "ws.invite": { en: "Invite Member", tr: "Üye Davet Et" },
  "ws.inviteEmail": { en: "Email address", tr: "E-posta adresi" },
  "ws.noWorkspace": { en: "No workspace yet. Create one to collaborate with your team.", tr: "Henüz çalışma alanı yok. Takımınızla çalışmak için bir tane oluşturun." },
  "ws.owner": { en: "Owner", tr: "Sahip" },
